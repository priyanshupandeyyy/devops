...
A \*\*Registry\*\* is a specialized server that stores and distributes Docker images. A \*\*Repository\*\* is a collection of specific versions (tags) of one image \_inside\_ that registry.
